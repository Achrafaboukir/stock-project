...
<h1>ram maintenance List</h1>
<form method="post" action="list_maintenance_ram.php">
...
<style>
  ...
  #filter{
    ...
    <table>
        ...
        $query = "SELECT * FROM suivi_maintenance_ram";
        if (!empty($rnum_serie)) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
                ...
                $countQuery = "SELECT COUNT(*) AS count FROM suivi_maintenance_ram WHERE rnum_serie = '".$row['rnum_serie']."'";
                ...
                echo "<a href='delete_ram_maintenance.php?idmaintenance=".$row['idmaintenance']."&rnum_serie=".$row['rnum_serie']."' onclick='return confirmDelete()'>Delete</a>";
                echo '<script>
