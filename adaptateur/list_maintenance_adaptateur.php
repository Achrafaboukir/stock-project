...
<h1>adaptateur maintenance List</h1>
<form method="post" action="list_maintenance_adaptateur.php">
...
<style>
  ...
  #filter{
    ...
    <table>
        ...
        $query = "SELECT * FROM suivi_maintenance_adaptateur";
        if (!empty($rnum_serie)) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
                ...
                $countQuery = "SELECT COUNT(*) AS count FROM suivi_maintenance_adaptateur WHERE rnum_serie = '".$row['rnum_serie']."'";
                ...
                echo "<a href='delete_adaptateur_maintenance.php?idmaintenance=".$row['idmaintenance']."&rnum_serie=".$row['rnum_serie']."' onclick='return confirmDelete()'>Delete</a>";
                echo '<script>
