...
<nav class=nav>
  <ul>
    <li><a href="http://localhost/circet/adaptateur/list_all.php" class="all">All</a></li>
    <li><a href="http://localhost/circet/adaptateur/list_use_adaptateur.php" class="in-use">In Use</a></li>
    <li><a href="http://localhost/circet/adaptateur/list_retour_adaptateur.php" class="in-maintenance">Roteur</a></li>
    <li><a href="http://localhost/circet/adaptateur/liste_adaptateur_deleted.php" class="in-maintenance">ENDEMAGER</a></li>
