<!DOCTYPE html><?php require 'navc.php';?><br><br>

<?php require 'secondnav.php';?>

<html>
<head><br><br>
<form method="post" action="liste_adaptateur_deleted.php">
...
<body>
	...
	<table>
		...
		<tbody>
			...
			$modele=$_POST['modele'];
			$marque=$_POST['marque'];
			$query = "SELECT * FROM adaptateur_stock_ferme where 1=1"; // Select all data from pcstock table
			if (!empty($NSerie)) {
			...
			while ($row = mysqli_fetch_assoc($result)) { // Loop through the result and output the data
                ...
                echo "<td>";
                echo "<a href='restore_adaptateur.php?rnum_serie=".$row['rnum_serie']."'>RESTORE</a>";
                echo "</td>";
				echo "</tr>";
			}
