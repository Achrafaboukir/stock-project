...
<form method="post" action="liste_discdur_deleted.php">
...
<body>
	...
	<table>
      ...
      $NSerie=$_POST['NSerie'];
			...
			$query = "SELECT * FROM disc_dur_stock_fermer where 1=1"; // Select all data from pcstock table
      ...
      if (!empty($NSerie)) {
			...
			while ($row = mysqli_fetch_assoc($result)) { // Loop through the result and output the data
                ...
                echo "<td>";
                echo "<a href='restore_discdur.php?dnum_serie=".$row['dnum_serie']."'>RESTORE</a>";
                echo "</td>";
				echo "</tr>";
			}
