...
<body>
	<form method="post" action="liste_clavier.php">
	...
	<table>
		...
		<tbody>
			...
			$modele=$_POST['modele'];
      $marque=$_POST['marque'];
			$query = "SELECT * FROM clavie_stock where etat='in stock'"; // Select all data from pcstock table
			if (!empty($num_serie)) {
